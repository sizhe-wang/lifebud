...
"[project]/node_modules/@mastra/core/dist/registry-generator-AVQXI3GX.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function atomicWriteFile(filePath, content, encoding = "utf-8") {
    ...
    try {
        await __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["default"].writeFile(tempPath, content, encoding);
        await __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["default"].rename(tempPath, filePath);
    } catch (error) {
        try {
            await __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["default"].unlink(tempPath);
        } catch  {}
        throw error;
    }
}
...
async function writeRegistryFiles(jsonPath, typesPath, providers, models) {
    const jsonDir = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].dirname(jsonPath);
    const typesDir = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].dirname(typesPath);
    await __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["default"].mkdir(jsonDir, {
        recursive: true
    });
    await __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["default"].mkdir(typesDir, {
        recursive: true
    });
    const registryData = {
        providers,
...
;
 //# sourceMappingURL=registry-generator-AVQXI3GX.js.map
 //# sourceMappingURL=registry-generator-AVQXI3GX.js.map
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__48d9c20b._.js.map