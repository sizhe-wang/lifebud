module.exports = [
"[project]/node_modules/@mastra/core/dist/chunk-6OBQKOBQ.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var coreMessageSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].union([
...
function standardizePrompt({ prompt, tools }) {
    ...
    if (prompt.messages != null) {
        ...
        const validationResult = safeValidateTypes({
            value: messages,
            schema: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].array(coreMessageSchema)
        });
...
var ToolExecutionError = class extends AISDKError {
    constructor({ toolArgs, toolName, toolCallId, cause, message = `Error executing tool ${toolName}: ${getErrorMessage(cause)}` }){
        super({
            name: name102,
            message,
            cause
...
;
 //# sourceMappingURL=chunk-6OBQKOBQ.js.map
 //# sourceMappingURL=chunk-6OBQKOBQ.js.map
}),
];

//# sourceMappingURL=node_modules_%40mastra_core_dist_chunk-6OBQKOBQ_2d34ec08.js.map