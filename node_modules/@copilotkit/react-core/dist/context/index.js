...
var CoAgentStateRendersContext = (0, import_react3.createContext)(
  void 0
);
function CoAgentStateRendersProvider({ children }) {
  const [coAgentStateRenders, setCoAgentStateRenders] = (0, import_react3.useState)({});
  const setCoAgentStateRender = (0, import_react3.useCallback)((id, stateRender) => {
    setCoAgentStateRenders((prevPoints) => __spreadProps(__spreadValues({}, prevPoints), {
      [id]: stateRender
    }));
  }, []);
  const removeCoAgentStateRender = (0, import_react3.useCallback)((id) => {
  ...
  const claimsRef = (0, import_react3.useRef)({});
...
function useCoAgentStateRenders() {
  const context = (0, import_react3.useContext)(CoAgentStateRendersContext);
  if (!context) {
...
var ThreadsContext = (0, import_react4.createContext)(void 0);
function ThreadsProvider({ children, threadId: explicitThreadId }) {
  const [internalThreadId, setThreadId] = (0, import_react4.useState)(explicitThreadId != null ? explicitThreadId : (0, import_shared.randomUUID)());
...
function useThreads() {
  const context = (0, import_react4.useContext)(ThreadsContext);
  if (!context) {
