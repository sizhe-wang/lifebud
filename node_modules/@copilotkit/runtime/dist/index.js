...
function convertActionInputToOpenAITool(action) {
  return {
    ...
    function: {
      ...
      parameters: shared.parseJson(action.jsonSchema, {})
    }
  };
}
...
function convertServiceAdapterError(error, adapterName) {
  ...
  const structuredError = new shared.CopilotKitLowLevelError({
  ...
  let newCode;
  if (statusCode === 401) {
    newCode = shared.CopilotKitErrorCode.AUTHENTICATION_ERROR;
  } else if (statusCode >= 400 && statusCode < 500) {
    newCode = shared.CopilotKitErrorCode.CONFIGURATION_ERROR;
  } else if (statusCode >= 500) {
    newCode = shared.CopilotKitErrorCode.NETWORK_ERROR;
  } else if (statusCode) {
    newCode = shared.CopilotKitErrorCode.CONFIGURATION_ERROR;
  } else {
    newCode = shared.CopilotKitErrorCode.NETWORK_ERROR;
...
var OpenAIAdapter = class {
  ...
  async process(request) {
    ...
    const threadId = threadIdFromRequest ?? shared.randomUUID();
...
function convertMessageToLangChainMessage(message) {
  if (message.isTextMessage()) {
    if (message.role == "user") {
      return new messages.HumanMessage(message.content);
    } else if (message.role == "assistant") {
      return new messages.AIMessage(message.content);
    } else if (message.role === "system") {
      return new messages.SystemMessage(message.content);
    }
  } else if (message.isActionExecutionMessage()) {
...
function convertActionInputToLangChainTool(actionInput) {
  return new tools.DynamicStructuredTool({
    ...
    schema: shared.convertJsonSchemaToZodSchema(JSON.parse(actionInput.jsonSchema), true),
    func: async () => {
      return "";
    }
  });
...
async function streamLangChainResponse({ result, eventStream$, actionExecution }) {
  ...
  if (typeof result === "string") {
    if (!actionExecution || (actionExecution == null ? void 0 : actionExecution.returnDirect)) {
      ...
      eventStream$.sendTextMessage(shared.randomId(), result);
    } else {
      eventStream$.sendActionExecutionResult({
        actionExecutionId: actionExecution.id,
        actionName: actionExecution.name,
    ...
    if (result.content) {
      eventStream$.sendTextMessage(shared.randomId(), result.content);
    }
    for (const toolCall of result.tool_calls) {
      eventStream$.sendActionExecution({
        actionExecutionId: toolCall.id || shared.randomId(),
      ...
      try {
        ...
        if (mode === null) {
          if (hasToolCall && toolCallId && toolCallName) {
            ...
            mode = "message";
            currentMessageId = ((_k = value.lc_kwargs) == null ? void 0 : _k.id) || shared.randomId();
            eventStream$.sendTextMessageStart({
              messageId: currentMessageId
            });
          }
  ...
  async process(request) {
    ...
    request.eventSource.stream(async (eventStream$) => {
      ...
      for await (const chunk of stream) {
        if (this.start) {
          model = chunk.model;
          currentMessageId = shared.randomId();
          eventStream$.sendTextMessageStart({
            messageId: currentMessageId
          });
          eventStream$.sendTextMessageContent({
...
`
    ...
    return {
      threadId: request.threadId || shared.randomUUID()
    };
  }
};
...
typeGraphql.registerEnumType(MessageRole, {
  name: "MessageRole",
  description: "The role of the message"
});
typeGraphql.registerEnumType(CopilotRequestType, {
  name: "CopilotRequestType",
  description: "The type of Copilot request"
});
typeGraphql.registerEnumType(ActionInputAvailability, {
...
_ts_decorate2([
  typeGraphql.Field(() => TextMessageInput, {
    nullable: true
  }),
...
_ts_decorate2([
  typeGraphql.Field(() => ActionExecutionMessageInput, {
    nullable: true
  }),
...
_ts_decorate3([
  typeGraphql.Field(() => ActionInputAvailability, {
    nullable: true
  }),
...
_ts_decorate5([
  typeGraphql.Field(() => GuardrailsRuleInput, {
    nullable: false
  }),
...
_ts_decorate6([
  typeGraphql.Field(() => GuardrailsInput, {
    nullable: true
  }),
...
_ts_decorate10([
  typeGraphql.Field(() => OpenAIApiAssistantAPIInput, {
    nullable: true
  }),
...
typeGraphql.registerEnumType(MessageStatusCode, {
...
_ts_decorate11([
  typeGraphql.Field(() => MessageStatusCode),
...
var MessageStatusUnion = typeGraphql.createUnionType({
  name: "MessageStatus",
  types: () => [
    PendingMessageStatus,
    SuccessMessageStatus,
...
typeGraphql.registerEnumType(ResponseStatusCode, {
...
_ts_decorate12([
  typeGraphql.Field(() => ResponseStatusCode),
...
typeGraphql.registerEnumType(FailedResponseStatusReason, {
...
_ts_decorate12([
  typeGraphql.Field(() => FailedResponseStatusReason),
  _ts_metadata12("design:type", String)
], FailedResponseStatus.prototype, "reason", void 0);
_ts_decorate12([
  typeGraphql.Field(() => graphqlScalars.GraphQLJSON, {
    nullable: true
  }),
...
var ResponseStatusUnion = typeGraphql.createUnionType({
  name: "ResponseStatus",
  types: () => [
    PendingResponseStatus,
    SuccessResponseStatus,
...
_ts_decorate13([
  typeGraphql.Field(() => OpenAIApiAssistantAPIResponse, {
    nullable: true
  }),
...
_ts_decorate14([
  typeGraphql.Field(() => MessageStatusUnion),
...
_ts_decorate14([
  typeGraphql.Field(() => ResponseStatusUnion),
  _ts_metadata14("design:type", Object)
...
_ts_decorate14([
  typeGraphql.Field(() => ExtensionsResponse, {
    nullable: true
  }),
...
typeGraphql.registerEnumType(MetaEventName, {
  name: "MetaEventName",
...
_ts_decorate15([
  typeGraphql.Field(() => MetaEventName),
  _ts_metadata15("design:type", String)
...
_ts_decorate15([
  typeGraphql.Field(() => CopilotKitLangGraphInterruptEventData),
...
_ts_decorate18([
  typeGraphql.Field(() => CopilotRequestType, {
    nullable: true
  }),
...
_ts_decorate18([
  typeGraphql.Field(() => GenerateCopilotResponseMetadataInput, {
    nullable: false
  }),
...
_ts_decorate18([
  typeGraphql.Field(() => ExtensionsInput, {
    nullable: true
  }),
...
var Message = class {
  ...
  status;
  constructor(props) {
    props.id ?? (props.id = shared.randomId());
...
var CopilotRuntime = class {
  ...
  get instance() {
    if (!this._instance) {
      this._instance = new runtime.CopilotRuntime(this.runtimeArgs);
    }
  ...
  getToolsFromActions(actions) {
    ...
    return actionsArray.map((action) => {
      const zodSchema = shared.getZodParameters(action.parameters || []);
      return {
        name: action.name,
        description: action.description || "",
    ...
    for (const config2 of effectiveEndpoints) {
      ...
      try {
        ...
        const toolDefs = Object.entries(toolsMap).map(([toolName, tool]) => {
          ...
          const zodSchema = shared.getZodParameters(params);
          return {
            name: toolName,
...
var telemetryClient = new shared.TelemetryClient({
  ...
  const endpointsInfo = remoteEndpoints.reduce((acc, endpoint) => {
    ...
    if (endpointType === EndpointType.LangGraphPlatform) {
      ...
      info = {
        ...
        hashedKey: ep.langsmithApiKey ? crypto.createHash("sha256").update(ep.langsmithApiKey).digest("hex") : null
      };
    }
    return info;
  }, {
...
var CopilotResolver = class {
  ...
  async generateCopilotResponse(ctx, data, properties) {
    ...
    logger2.debug("Processing");
    let runtimeResponse;
    const { eventSource, threadId = shared.randomId(), runId, serverSideActions, actionInputsWithoutAgents, extensions } = runtimeResponse;
    logger2.debug("Event source created, creating response");
    ...
    const response = {
      threadId,
      runId,
      status: rxjs.firstValueFrom(responseStatus$),
      extensions,
      metaEvents: new graphqlYoga.Repeater(async (push, stop) => {
          ...
          next: async (event) => {
            ...
            switch (event.name) {
              case LangGraphEventTypes.OnInterrupt:
                push(classTransformer.plainToInstance(LangGraphInterruptEvent, {
                  // @ts-ignore
                  type: event.type,
                  // @ts-ignore
              ...
              case RuntimeMetaEventName.CopilotKitLangGraphInterruptEvent:
                push(classTransformer.plainToInstance(CopilotKitLangGraphInterruptEvent, {
                  type: event.type,
                  name: event.name,
                  data: {
                    ...
                    messages: event.data.messages.map((message) => {
                      if (message.type === "TextMessage" || "content" in message && "role" in message) {
                        return classTransformer.plainToInstance(TextMessage, {
                          id: message.id,
                      ...
                      if ("arguments" in message) {
                        return classTransformer.plainToInstance(ActionExecutionMessage, {
                          name: message.name,
                          id: message.id,
                          arguments: [
      ...
      messages: new graphqlYoga.Repeater(async (pushMessage, stopStreamingMessages) => {
        var _a2;
          ...
          invokeGuardrails({
            ...
            onResult: (result) => {
              ...
              if (result.status === "denied") {
                ...
                outputMessages = [
                  classTransformer.plainToInstance(TextMessage, {
                    id: shared.randomId(),
                    createdAt: /* @__PURE__ */ new Date(),
        ...
        eventStreamSubscription = eventStream.subscribe({
            ...
            switch (event.type) {
              ...
              case RuntimeEventTypes.TextMessageStart:
                const textMessageContentStream = eventStream.pipe(
                  ...
                  rxjs.skipWhile((e) => e !== event),
                  // take until the message end event
                  rxjs.takeWhile((e) => !(e.type === RuntimeEventTypes.TextMessageEnd && e.messageId == event.messageId)),
                  // filter out any other message events or message ids
                  rxjs.filter((e) => e.type == RuntimeEventTypes.TextMessageContent && e.messageId == event.messageId)
                );
                ...
                pushMessage({
                  ...
                  status: rxjs.firstValueFrom(streamingTextStatus),
                  createdAt: /* @__PURE__ */ new Date(),
                  role: MessageRole.assistant,
                  content: new graphqlYoga.Repeater(async (pushTextChunk, stopStreamingText) => {
                    logger2.debug("Text message content repeater created");
                    const textChunks = [];
                    let textSubscription;
                    interruptStreaming$.pipe(rxjs.shareReplay(), rxjs.take(1), rxjs.tap(({ reason, messageId: messageId2 }) => {
                      logger2.debug({
                        reason,
                        messageId: messageId2
                      }, "Text streaming interrupted");
                      streamingTextStatus.next(classTransformer.plainToInstance(FailedMessageStatus, {
                        reason
                      }));
                    ...
                    textSubscription = textMessageContentStream.subscribe({
                      ...
                      complete: () => {
                        ...
                        stopStreamingText();
                        textSubscription == null ? void 0 : textSubscription.unsubscribe();
                        outputMessages.push(classTransformer.plainToInstance(TextMessage, {
                          id: messageId,
                          createdAt: /* @__PURE__ */ new Date(),
              ...
              case RuntimeEventTypes.ActionExecutionStart:
                ...
                const actionExecutionArgumentStream = eventStream.pipe(
                  ...
                  rxjs.takeWhile((e) => !(e.type === RuntimeEventTypes.ActionExecutionEnd && e.actionExecutionId == event.actionExecutionId)),
                  // filter out any other action execution events or action execution ids
                  rxjs.filter((e) => e.type == RuntimeEventTypes.ActionExecutionArgs && e.actionExecutionId == event.actionExecutionId)
                );
                const streamingArgumentsStatus = new rxjs.Subject();
                pushMessage({
                  id: event.actionExecutionId,
                  parentMessageId: event.parentMessageId,
                  status: rxjs.firstValueFrom(streamingArgumentsStatus),
                  createdAt: /* @__PURE__ */ new Date(),
                  name: event.actionName,
                  arguments: new graphqlYoga.Repeater(async (pushArgumentsChunk, stopStreamingArguments) => {
                    ...
                    actionExecutionArgumentSubscription = actionExecutionArgumentStream.subscribe({
                      ...
                      error: (err) => {
                        ...
                        streamingArgumentsStatus.next(classTransformer.plainToInstance(FailedMessageStatus, {
                      ...
                      complete: () => {
                        ...
                        stopStreamingArguments();
                        actionExecutionArgumentSubscription == null ? void 0 : actionExecutionArgumentSubscription.unsubscribe();
                        outputMessages.push(classTransformer.plainToInstance(ActionExecutionMessage, {
                          id: event.actionExecutionId,
                          createdAt: /* @__PURE__ */ new Date(),
                          name: event.actionName,
              ...
              case RuntimeEventTypes.ActionExecutionResult:
                ...
                outputMessages.push(classTransformer.plainToInstance(ResultMessage, {
                  id: "result-" + event.actionExecutionId,
                  createdAt: /* @__PURE__ */ new Date(),
                  actionExecutionId: event.actionExecutionId,
                  actionName: event.actionName,
              ...
              case RuntimeEventTypes.AgentStateMessage:
                ...
                outputMessages.push(classTransformer.plainToInstance(AgentStateMessage, {
                  id: shared.randomId(),
                  threadId: event.threadId,
                  agentName: event.agentName,
                  nodeName: event.nodeName,
          ...
          error: (err) => {
            ...
            if (err instanceof shared.CopilotKitError || err instanceof shared.CopilotKitLowLevelError || err instanceof Error && err.name && err.name.includes("CopilotKit") || ((_a3 = err == null ? void 0 : err.extensions) == null ? void 0 : _a3.visibility)) {
              responseStatus$.next(new UnknownErrorResponse({
                description: err.message || "Agent error occurred",
          ...
          complete: async () => {
            ...
            if ((_a3 = data.cloud) == null ? void 0 : _a3.guardrails) {
              ...
              await rxjs.firstValueFrom(guardrailsResult$);
            }
            responseStatus$.next(new SuccessResponseStatus());
            eventStreamSubscription == null ? void 0 : eventStreamSubscription.unsubscribe();
            stopStreamingMessages();
...
_ts_decorate20([
  typeGraphql.Query(() => AgentsResponse),
  _ts_param(0, typeGraphql.Ctx()),
  _ts_metadata20("design:type", Function),
  _ts_metadata20("design:paramtypes", [
...
_ts_decorate20([
  typeGraphql.Mutation(() => CopilotResponse),
  _ts_param(0, typeGraphql.Ctx()),
  _ts_param(1, typeGraphql.Arg("data")),
  _ts_param(2, typeGraphql.Arg("properties", () => graphqlScalars.GraphQLJSONObject, {
    nullable: true
  })),
  _ts_metadata20("design:type", Function),
  _ts_metadata20("design:paramtypes", [
...
CopilotResolver = _ts_decorate20([
  typeGraphql.Resolver(() => CopilotResponse)
], CopilotResolver);
function createLogger(options) {
  const { level, component } = options || {};
  const stream = pretty__default.default({
    colorize: true
  });
  const logger2 = createPinoLogger__default.default({
...
_ts_decorate23([
  typeGraphql.Query(() => LoadAgentStateResponse),
  _ts_param2(0, typeGraphql.Ctx()),
  _ts_param2(1, typeGraphql.Arg("data")),
...
StateResolver = _ts_decorate23([
  typeGraphql.Resolver(() => LoadAgentStateResponse)
], StateResolver);
...
function getCommonConfig(options) {
  ...
  const userErrorCodes = [
    shared.CopilotKitErrorCode.AGENT_NOT_FOUND,
    shared.CopilotKitErrorCode.API_NOT_FOUND,
    shared.CopilotKitErrorCode.REMOTE_ENDPOINT_NOT_FOUND,
    shared.CopilotKitErrorCode.CONFIGURATION_ERROR,
    shared.CopilotKitErrorCode.MISSING_PUBLIC_API_KEY_ERROR
  ];
  return {
    ...
    schema: buildSchema(),
    plugins: [
      pluginDeferStream.useDeferStream(),
    ...
    maskedErrors: {
      maskError: (error, message, isDev) => {
        ...
        if (originalError instanceof shared.CopilotKitError && userErrorCodes.includes(originalError.code)) {
          console.debug("User configuration error:", error.message);
          return error;
        }
  ...
  async process(request) {
    ...
    try {
      ...
      eventSource.stream(async (eventStream$) => {
        ...
        let currentMessageId = shared.randomId();
        let currentToolCallId = shared.randomId();
    ...
    return {
      threadId: threadId || shared.randomUUID()
    };
  }
};
...
exports.EmptyAdapter = EmptyAdapter;
exports.ExperimentalEmptyAdapter = ExperimentalEmptyAdapter;
exports.ExperimentalOllamaAdapter = ExperimentalOllamaAdapter;
exports.GoogleGenerativeAIAdapter = GoogleGenerativeAIAdapter;
...
exports.convertMCPToolsToActions = convertMCPToolsToActions;
exports.convertServiceAdapterError = convertServiceAdapterError;
exports.copilotKitEndpoint = copilotKitEndpoint;
exports.copilotRuntimeNestEndpoint = copilotRuntimeNestEndpoint;
exports.copilotRuntimeNextJSAppRouterEndpoint = copilotRuntimeNextJSAppRouterEndpoint;
exports.copilotRuntimeNextJSPagesRouterEndpoint = copilotRuntimeNextJSPagesRouterEndpoint;
exports.copilotRuntimeNodeExpressEndpoint = copilotRuntimeNodeExpressEndpoint;
exports.copilotRuntimeNodeHttpEndpoint = copilotRuntimeNodeHttpEndpoint;
exports.createContext = createContext;
exports.createLogger = createLogger;
exports.extractParametersFromSchema = extractParametersFromSchema;
