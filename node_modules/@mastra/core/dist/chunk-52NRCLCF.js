import { WorkflowEventProcessor } from './chunk-7ID3GCY2.js';
import { isToolLoopAgentLike, toolLoopAgentToMastraAgent } from './chunk-RYYO3WBT.js';
import { createOnScorerHook } from './chunk-NCNYUGXD.js';
import { EventEmitterPubSub, augmentWithInit, Agent } from './chunk-5A5RM7PH.js';
import { noopLogger } from './chunk-PSCMWPLC.js';
import { registerHook } from './chunk-L54GIUCB.js';
import { NoOpObservability } from './chunk-XKBYPAOY.js';
...
var Mastra = class {
  ...
  #syncGatewayRegistry() {
    try {
      ...
      import('./provider-registry-ZA6LYZWF.js').then(async ({ GatewayRegistry }) => {
