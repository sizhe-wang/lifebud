...
var anthropicProviderOptions = z4.z.object({
  sendReasoning: z4.z.boolean().optional(),
  thinking: z4.z.object({
    type: z4.z.union([z4.z.literal("enabled"), z4.z.literal("disabled")]),
...
var googleSearch = createProviderDefinedToolFactory({
  ...
  inputSchema: lazySchema(
    () => zodSchema(
      z4.z.object({
        mode: z4.z.enum(["MODE_DYNAMIC", "MODE_UNSPECIFIED"]).default("MODE_UNSPECIFIED"),
        dynamicThreshold: z4.z.number().default(1)
      })
    )
  )
});
...
var webSearchInputSchema = lazySchema(() => zodSchema(z4.z.object({})));
...
//# sourceMappingURL=chunk-5KJXHJ4M.cjs.map
//# sourceMappingURL=chunk-5KJXHJ4M.cjs.map