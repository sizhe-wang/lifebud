...
// src/voice/voice.ts
var MastraVoice = class extends chunkDGV2FWB4_cjs.MastraBase {
  listeningModel;
  speechModel;
  speaker;
  realtimeConfig;
...
var AISDKSpeech = class extends MastraVoice {
  ...
  async speak(input, options) {
    ...
    const result = await chunkCVLIEFWM_cjs.generateSpeech({
      model: this.model,
      text,
...
var AISDKTranscription = class extends MastraVoice {
  ...
  async listen(audioStream, options) {
    ...
    const result = await chunkCVLIEFWM_cjs.transcribe({
      model: this.model,
      audio: audioBuffer,
      providerOptions: options?.providerOptions,
      abortSignal: options?.abortSignal,
...
//# sourceMappingURL=chunk-KHO4KFXW.cjs.map
//# sourceMappingURL=chunk-KHO4KFXW.cjs.map