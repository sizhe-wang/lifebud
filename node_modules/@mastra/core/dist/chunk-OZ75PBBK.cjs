        ...
        if (!context) {
          ...
          if (isAgentExecution && !baseContext.agent) {
            ...
            organizedContext = {
              ...
              requestContext: rest.requestContext || new chunkSMM2C4KH_cjs.RequestContext()
            };
            ...
            organizedContext = {
              ...
              requestContext: baseContext.requestContext || new chunkSMM2C4KH_cjs.RequestContext()
            };
          }
        }
...
//# sourceMappingURL=chunk-OZ75PBBK.cjs.map
//# sourceMappingURL=chunk-OZ75PBBK.cjs.map