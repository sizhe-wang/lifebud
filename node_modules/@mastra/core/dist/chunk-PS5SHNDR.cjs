...
var chunkKHO4KFXW_cjs = require('./chunk-KHO4KFXW.cjs');
var chunkLJOQ7WYC_cjs = require('./chunk-LJOQ7WYC.cjs');
var chunkZEWJUWNE_cjs = require('./chunk-ZEWJUWNE.cjs');
var chunkJ4KVR4DZ_cjs = require('./chunk-J4KVR4DZ.cjs');
var chunkCVLIEFWM_cjs = require('./chunk-CVLIEFWM.cjs');
var chunkPM3UIIBK_cjs = require('./chunk-PM3UIIBK.cjs');
var chunkFXH6E6IX_cjs = require('./chunk-FXH6E6IX.cjs');
var chunkHTNZMI2D_cjs = require('./chunk-HTNZMI2D.cjs');
...
var ProcessorRunner = class _ProcessorRunner {
  ...
  static async validateAndFormatProcessInputStepResult(result, {
    ...
    if (result instanceof chunkJ4KVR4DZ_cjs.MessageList) {
      ...
      if (result.model) {
        const resolvedModel = await chunkFXH6E6IX_cjs.resolveModelConfig(result.model);
...
var ObjectFormatHandler = class extends BaseFormatHandler {
  ...
  async processPartialChunk({
    ...
    const { value: currentObjectJson, state } = await chunkCVLIEFWM_cjs.parsePartialJson(processedAccumulatedText);
    if (this.validatePartialChunks && this.partialSchema) {
      const result = this.partialSchema?.safeParse(currentObjectJson);
      if (result.success && result.data && result.data !== void 0 && !chunkCVLIEFWM_cjs.isDeepEqualData(previousObject, result.data)) {
        return {
          shouldEmit: true,
    ...
    if (currentObjectJson !== void 0 && currentObjectJson !== null && typeof currentObjectJson === "object" && !chunkCVLIEFWM_cjs.isDeepEqualData(previousObject, currentObjectJson)) {
      return {
  ...
  async validateAndTransformFinal(finalRawValue) {
    ...
    const { value } = await chunkCVLIEFWM_cjs.parsePartialJson(rawValue);
...
var ArrayFormatHandler = class extends BaseFormatHandler {
  ...
  async processPartialChunk({
    ...
    const processedAccumulatedText = this.preprocessText(accumulatedText);
    const { value: currentObjectJson, state: parseState } = await chunkCVLIEFWM_cjs.parsePartialJson(processedAccumulatedText);
    if (currentObjectJson !== void 0 && !chunkCVLIEFWM_cjs.isDeepEqualData(previousObject, currentObjectJson)) {
      ...
      if (!chunkCVLIEFWM_cjs.isDeepEqualData(this.textPreviousFilteredArray, filteredElements)) {
...
var EnumFormatHandler = class extends BaseFormatHandler {
  ...
  async processPartialChunk({
    ...
    const processedAccumulatedText = this.preprocessText(accumulatedText);
    const { value: currentObjectJson } = await chunkCVLIEFWM_cjs.parsePartialJson(processedAccumulatedText);
    if (currentObjectJson !== void 0 && currentObjectJson !== null && typeof currentObjectJson === "object" && !Array.isArray(currentObjectJson) && "result" in currentObjectJson && typeof currentObjectJson.result === "string" && !chunkCVLIEFWM_cjs.isDeepEqualData(previousObject, currentObjectJson)) {
  ...
  async validateAndTransformFinal(rawFinalValue) {
    ...
    const { value } = await chunkCVLIEFWM_cjs.parsePartialJson(processedValue);
...
var MastraModelOutput = class extends chunkDGV2FWB4_cjs.MastraBase {
  #status = "running";
  #error;
  #baseStream;
  #bufferedChunks = [];
            ...
            case "finish":
              ...
              try {
                if (self.processorRunner && !self.#options.isLLMExecutionStep) {
                  ...
                  const outputText = lastResponseMessage ? chunkJ4KVR4DZ_cjs.coreContentToString(lastResponseMessage.content) : "";
  ...
  switch (chunk.type) {
    ...
    case "file":
      if (mode === "generate") {
        return {
          type: "file",
          file: new chunkJ4KVR4DZ_cjs.DefaultGeneratedFile({
      ...
      return {
        type: "file",
        file: new chunkJ4KVR4DZ_cjs.DefaultGeneratedFileWithType({
          data: chunk.payload.data,
          mediaType: chunk.payload.mimeType
        })
      };
...
var ExecutionEngine = class extends chunkDGV2FWB4_cjs.MastraBase {
  mastra;
  options;
  constructor({ mastra, options }) {
    super({ name: "ExecutionEngine", component: chunkAF74UXR5_cjs.RegisteredLogger.WORKFLOW });
    this.mastra = mastra;
    this.options = options;
  }
...
async function validateStepInput({
  ...
  let validationError;
  if (validateInputs && chunkPPEP5ZHX_cjs.isZodType(step.inputSchema)) {
...
async function validateStepResumeData({ resumeData, step }) {
  ...
  if (resumeSchema && chunkPPEP5ZHX_cjs.isZodType(resumeSchema)) {
...
async function validateStepSuspendData({
  ...
  if (suspendSchema && validateInputs && chunkPPEP5ZHX_cjs.isZodType(suspendSchema)) {
...
async function validateStepStateData({
  ...
  if (stateSchema && validateInputs && chunkPPEP5ZHX_cjs.isZodType(stateSchema)) {
...
var createTimeTravelExecutionParams = (params) => {
  ...
  for (const [index, entry] of graph.steps.entries()) {
    ...
    stepIds.forEach((stepId) => {
      ...
      if (result) {
        const formattedResult = chunkPPEP5ZHX_cjs.removeUndefinedValues(result);
      ...
      const context = createDeprecationProxy(
        {
          ...
          [chunkLJOQ7WYC_cjs.STREAM_FORMAT_SYMBOL]: executionContext.format,
  ...
  do {
    ...
    const evalSpan = await engine.createChildSpan({
      ...
      options: {
        ...
        input: chunkPPEP5ZHX_cjs.selectFields(result.output, ["stepResult", "output.text", "output.object", "messages"]),
        attributes: {
...
async function executeStep(engine, params) {
  ...
  const stepRetryResult = await engine.executeStepWithRetry(
    ...
    async () => {
      ...
      const mastraForStep = engine.mastra ? isNestedWorkflow ? engine.mastra : chunkS65YV6YB_cjs.wrapMastra(engine.mastra, { currentSpan: stepSpan }) : void 0;
...
function isStepParams(input) {
  return input !== null && typeof input === "object" && "id" in input && "execute" in input && !(input instanceof Agent) && !(input instanceof chunkOZ75PBBK_cjs.Tool);
}
...
function createStepFromAgent(params, agentOrToolOptions) {
  ...
  return {
    ...
    execute: async ({
      ...
      runId,
      [chunkLJOQ7WYC_cjs.PUBSUB_SYMBOL]: pubsub,
      [chunkLJOQ7WYC_cjs.STREAM_FORMAT_SYMBOL]: streamFormat,
      requestContext,
      tracingContext,
      abortSignal,
      abort,
...
function isProcessor(obj) {
  return obj !== null && typeof obj === "object" && "id" in obj && typeof obj.id === "string" && !(obj instanceof Agent) && !(obj instanceof chunkOZ75PBBK_cjs.Tool) && (typeof obj.processInput === "function" || typeof obj.processInputStep === "function" || typeof obj.processOutputStream === "function" || typeof obj.processOutputResult === "function" || typeof obj.processOutputStep === "function");
}
...
var Workflow = class extends chunkDGV2FWB4_cjs.MastraBase {
  id;
  description;
  inputSchema;
  outputSchema;
  ...
  constructor({
    ...
    super({ name: id, component: chunkAF74UXR5_cjs.RegisteredLogger.WORKFLOW });
    this.id = id;
...
var Run = class {
  ...
  async _validateInput(inputData) {
    ...
    if (this.validateInputs && this.inputSchema && chunkPPEP5ZHX_cjs.isZodType(this.inputSchema)) {
  ...
  async _validateInitialState(initialState) {
    ...
    if (this.validateInputs) {
      ...
      if (stateSchema && chunkPPEP5ZHX_cjs.isZodType(stateSchema)) {
  ...
  async _validateResumeData(resumeData, suspendedStep) {
    ...
    if (suspendedStep && suspendedStep.resumeSchema && this.validateInputs && chunkPPEP5ZHX_cjs.isZodType(suspendedStep.resumeSchema)) {
  ...
  async _validateTimetravelInputData(inputData, step) {
    let inputDataToUse = inputData;
    if (step && step.inputSchema && this.validateInputs && chunkPPEP5ZHX_cjs.isZodType(step.inputSchema)) {
      const inputSchema = step.inputSchema;
  ...
  async _start({
    ...
    const workflowSpan = chunkS65YV6YB_cjs.getOrCreateSpan({
  ...
  async _resume(params) {
    ...
    const requestContextToUse = params.requestContext ?? new chunkSMM2C4KH_cjs.RequestContext();
  ...
  async _restart({
    ...
    const requestContextToUse = requestContext ?? new chunkSMM2C4KH_cjs.RequestContext();
...
var MastraModelInput = class extends chunkDGV2FWB4_cjs.MastraBase {
      ...
      const { outputStream, callBail, runState, stepTools } = await executeStreamWithFallbackModels(
        ...
        if (inputStepProcessors && inputStepProcessors.length > 0) {
          const processorRunner = new ProcessorRunner({
            ...
            outputProcessors: [],
            logger: logger || new chunkAF74UXR5_cjs.ConsoleLogger({ level: "error" }),
...
Analyse the suspended tools: ${JSON.stringify(suspendedTools)}, using the messages available to you and the resumeSchema of each suspended tool, find the tool whose resumeData you can construct properly.
        ...
        if (isSupportedLanguageModel(currentStep.model)) {
          modelResult = chunkS65YV6YB_cjs.executeWithContextSync({
...
var MastraScorer = class _MastraScorer {
  ...
  async executePromptStep(scorerStep, tracingContext, context) {
    ...
    const resolvedModel = await chunkFXH6E6IX_cjs.resolveModelConfig(modelConfig, void 0, this.#mastra);
...
var MastraLLMVNext = class extends chunkDGV2FWB4_cjs.MastraBase {
  #models;
  #mastra;
  #options;
  #firstModel;
  ...
  stream({
    resumeContext,
    runId,
    stopWhen = chunkCVLIEFWM_cjs.stepCountIs(5),
    maxSteps,
    tools = {},
    modelSettings,
    toolChoice = "auto",
    ...
    if (maxSteps && typeof maxSteps === "number") {
      stopWhenToUse = chunkCVLIEFWM_cjs.stepCountIs(maxSteps);
    } else {
...
async function getRoutingAgent({
  ...
  const toolList = Object.entries({ ...toolsToUse, ...memoryTools }).map(([name, tool2]) => {
    return ` - **${name}**: ${tool2.description}, input schema: ${JSON.stringify(
      chunk4WQYXT2I_cjs.zodToJsonSchema("inputSchema" in tool2 ? tool2.inputSchema : z10__default.default.object({}))
    )}`;
  }).join("\n");
...
async function prepareMemoryStep({
  ...
  if (typeof messages === "string") {
    ...
    const messageList = new chunkJ4KVR4DZ_cjs.MessageList({
      threadId: thread?.id,
      resourceId: thread?.resourceId
    });
...
var AgentLegacyHandler = class {
  ...
  __primitive({
    ...
    return {
      before: async () => {
        ...
        const agentSpan = chunkS65YV6YB_cjs.getOrCreateSpan({
        ...
        let messageList = new chunkJ4KVR4DZ_cjs.MessageList({
          threadId,
          resourceId,
      ...
      after: async ({
        ...
        const messageListResponses = new chunkJ4KVR4DZ_cjs.MessageList({
          threadId,
          resourceId,
          generateMessageId: this.capabilities.mastra?.generateId?.bind(this.capabilities.mastra),
          // @ts-ignore Flag for agent network messages
  ...
  async prepareLLMOptions(messages, options, methodType) {
    ...
    const resourceIdFromContext = requestContext.get(chunkSMM2C4KH_cjs.MASTRA_RESOURCE_ID_KEY);
    const threadIdFromContext = requestContext.get(chunkSMM2C4KH_cjs.MASTRA_THREAD_ID_KEY);
  ...
  async generateLegacy(messages, generateOptions = {}) {
    ...
    if (!output || experimental_output) {
      ...
      const outputProcessorResult2 = await this.capabilities.__runOutputProcessors({
        requestContext: contextWithMemory || new chunkSMM2C4KH_cjs.RequestContext(),
        tracingContext,
...
var prepareMemoryStepOutputSchema = z10.z.object({
  ...
  messageList: z10.z.instanceof(chunkJ4KVR4DZ_cjs.MessageList),
  ...
  return createStep({
    ...
    execute: async ({ inputData, tracingContext }) => {
      ...
      const processors = validatedInputData.outputProcessors || (capabilities.outputProcessors ? typeof capabilities.outputProcessors === "function" ? await capabilities.outputProcessors({
        requestContext: validatedInputData.requestContext || new chunkSMM2C4KH_cjs.RequestContext()
      }) : capabilities.outputProcessors : []);
      const modelMethodType = getModelMethodFromAgentMethod(methodType);
...
var Agent = class extends chunkDGV2FWB4_cjs.MastraBase {
  id;
  name;
  #instructions;
  #description;
   ...
   */
  constructor(config) {
    super({ component: chunkAF74UXR5_cjs.RegisteredLogger.AGENT });
    ...
    if (config.voice) {
      ...
      this.#voice = new chunkKHO4KFXW_cjs.DefaultVoice();
    }
   ...
   * ```
   */
  listAgents({ requestContext = new chunkSMM2C4KH_cjs.RequestContext() } = {}) {
  ...
  async listResolvedOutputProcessors(requestContext) {
    const configuredProcessors = this.#outputProcessors ? typeof this.#outputProcessors === "function" ? await this.#outputProcessors({ requestContext: requestContext || new chunkSMM2C4KH_cjs.RequestContext() }) : this.#outputProcessors : [];
    const memory = await this.getMemory({ requestContext: requestContext || new chunkSMM2C4KH_cjs.RequestContext() });
  ...
  async listResolvedInputProcessors(requestContext) {
    const configuredProcessors = this.#inputProcessors ? typeof this.#inputProcessors === "function" ? await this.#inputProcessors({ requestContext: requestContext || new chunkSMM2C4KH_cjs.RequestContext() }) : this.#inputProcessors : [];
    const memory = await this.getMemory({ requestContext: requestContext || new chunkSMM2C4KH_cjs.RequestContext() });
  ...
  async getConfiguredProcessorWorkflows() {
    ...
    if (this.#inputProcessors) {
      const inputProcessors = typeof this.#inputProcessors === "function" ? await this.#inputProcessors({ requestContext: new chunkSMM2C4KH_cjs.RequestContext() }) : this.#inputProcessors;
    ...
    if (this.#outputProcessors) {
      const outputProcessors = typeof this.#outputProcessors === "function" ? await this.#outputProcessors({ requestContext: new chunkSMM2C4KH_cjs.RequestContext() }) : this.#outputProcessors;
   ...
   * ```
   */
  async getMemory({ requestContext = new chunkSMM2C4KH_cjs.RequestContext() } = {}) {
    if (!this.#memory) {
      return void 0;
    }
    let resolvedMemory;
  ...
  async getVoice({ requestContext } = {}) {
    if (this.#voice) {
      ...
      return new chunkKHO4KFXW_cjs.DefaultVoice();
    }
  }
  /**
   ...
   * ```
   */
  getInstructions({ requestContext = new chunkSMM2C4KH_cjs.RequestContext() } = {}) {
    if (typeof this.#instructions === "function") {
   ...
   * ```
   */
  getDefaultOptions({ requestContext = new chunkSMM2C4KH_cjs.RequestContext() } = {}) {
   ...
   * ```
   */
  getDefaultNetworkOptions({ requestContext = new chunkSMM2C4KH_cjs.RequestContext() } = {}) {
   ...
   * ```
   */
  listTools({ requestContext = new chunkSMM2C4KH_cjs.RequestContext() } = {}) {
    if (typeof this.#tools !== "function") {
      return chunkPPEP5ZHX_cjs.ensureToolProperties(this.#tools);
    }
    ...
    return resolveMaybePromise(result, (tools) => {
      ...
      return chunkPPEP5ZHX_cjs.ensureToolProperties(tools);
    });
  }
  /**
  ...
  getLLM({
    ...
    return resolveMaybePromise(modelToUse, (resolvedModel) => {
      ...
      if (isSupportedLanguageModel(resolvedModel)) {
        ...
        llm = new chunkHTNZMI2D_cjs.MastraLLMV1({
          model: resolvedModel,
          mastra: this.#mastra,
          options: { tracingPolicy: this.#options?.tracingPolicy }
        });
  ...
  async resolveModelConfig(modelConfig, requestContext) {
    try {
      return await chunkFXH6E6IX_cjs.resolveModelConfig(modelConfig, requestContext, this.#mastra);
    } catch (error) {
      const mastraError = new chunk4U7ZLI36_cjs.MastraError({
   ...
   * ```
   */
  async getModelList(requestContext = new chunkSMM2C4KH_cjs.RequestContext()) {
  ...
  async generateTitleFromUserMessage({
    ...
    const normMessage = new chunkJ4KVR4DZ_cjs.MessageList().add(message, "user").get.all.ui().at(-1);
    if (!normMessage) {
    ...
    if (isSupportedLanguageModel(llm.getModel())) {
      const messageList = new chunkJ4KVR4DZ_cjs.MessageList().add(
        [
          {
            role: "system",
  ...
  async genTitle(userMessage, requestContext, tracingContext, model, instructions) {
    try {
      if (userMessage) {
        const normMessage = new chunkJ4KVR4DZ_cjs.MessageList().add(userMessage, "user").get.all.ui().at(-1);
        if (normMessage) {
  ...
  async listMemoryTools({
    ...
    if (memoryTools) {
      ...
      for (const [toolName, tool2] of Object.entries(memoryTools)) {
        ...
        const convertedToCoreTool = chunkPPEP5ZHX_cjs.makeCoreTool(toolObj, options, void 0, autoResumeSuspendedTools);
  ...
  async listAssignedTools({
    ...
    const assignedCoreToolEntries = await Promise.all(
      assignedToolEntries.map(async ([k, tool2]) => {
        ...
        return [k, chunkPPEP5ZHX_cjs.makeCoreTool(tool2, options, void 0, autoResumeSuspendedTools)];
      })
    );
    ...
    if (toolsFromToolsets.length > 0) {
      ...
      for (const toolset of toolsFromToolsets) {
        for (const [toolName, tool2] of Object.entries(toolset)) {
          ...
          const convertedToCoreTool = chunkPPEP5ZHX_cjs.makeCoreTool(toolObj, options, "toolset", autoResumeSuspendedTools);
  ...
  async listClientTools({
    ...
    if (clientToolsForInput.length > 0) {
      ...
      for (const [toolName, tool2] of clientToolsForInput) {
        ...
        const convertedToCoreTool = chunkPPEP5ZHX_cjs.makeCoreTool(rest, options, "client-tool", autoResumeSuspendedTools);
        toolsForRequest[toolName] = convertedToCoreTool;
      }
    }
    return toolsForRequest;
  ...
  async listAgentTools({
    ...
    if (Object.keys(agents).length > 0) {
      for (const [agentName, agent] of Object.entries(agents)) {
        ...
        const toolObj = chunkOZ75PBBK_cjs.createTool({
          id: `agent-${agentName}`,
        ...
        convertedAgentTools[`agent-${agentName}`] = chunkPPEP5ZHX_cjs.makeCoreTool(
          toolObj,
          options,
          void 0,
          autoResumeSuspendedTools
  ...
  async listWorkflowTools({
    ...
    if (Object.keys(workflows).length > 0) {
      for (const [workflowName, workflow] of Object.entries(workflows)) {
        ...
        convertedWorkflowTools[`workflow-${workflowName}`] = chunkPPEP5ZHX_cjs.makeCoreTool(
          toolObj,
          options,
          void 0,
          autoResumeSuspendedTools
  ...
  async convertTools({
    ...
    if (this.#mastra) {
      mastraProxy = chunkPPEP5ZHX_cjs.createMastraProxy({ mastra: this.#mastra, logger });
    }
  ...
  async prepareModels(requestContext, model) {
    if (model || !Array.isArray(this.model)) {
      ...
      let headers;
      if (resolvedModel instanceof chunkFXH6E6IX_cjs.ModelRouterLanguageModel) {
    ...
    const models = await Promise.all(
      this.model.map(async (modelConfig) => {
        ...
        let headers;
        if (model2 instanceof chunkFXH6E6IX_cjs.ModelRouterLanguageModel) {
  ...
  async #execute({ methodType, resumeContext, ...options }) {
    ...
    const requestContext = options.requestContext || new chunkSMM2C4KH_cjs.RequestContext();
    const resourceIdFromContext = requestContext.get(chunkSMM2C4KH_cjs.MASTRA_RESOURCE_ID_KEY);
    const threadIdFromContext = requestContext.get(chunkSMM2C4KH_cjs.MASTRA_THREAD_ID_KEY);
    ...
    if ("structuredOutput" in options && options.structuredOutput?.schema) {
      ...
      if (targetProvider.includes("openai") || targetModelId.includes("openai")) {
        if (chunkPPEP5ZHX_cjs.isZodType(options.structuredOutput.schema) && targetModelId) {
          const modelInfo = {
  ...
  async network(messages, options) {
    const requestContextToUse = options?.requestContext || new chunkSMM2C4KH_cjs.RequestContext();
    ...
    const resourceIdFromContext = requestContextToUse.get(chunkSMM2C4KH_cjs.MASTRA_RESOURCE_ID_KEY);
    const threadIdFromContext = requestContextToUse.get(chunkSMM2C4KH_cjs.MASTRA_THREAD_ID_KEY);
...
var SemanticRecall = class {
  ...
  formatCrossThreadMessages(messages, currentThreadId) {
    let result = ``;
    const v1Messages = new chunkJ4KVR4DZ_cjs.MessageList().add(messages, "memory").get.all.v1();
    let lastYmd = null;
...
var MemoryProcessor = class extends chunkDGV2FWB4_cjs.MastraBase {
  /**
...
https://mastra.ai/en/docs/memory/semantic-recall`
      ...
      if (typeof config.embedder === "string") {
        this.embedder = new chunkFXH6E6IX_cjs.ModelRouterEmbeddingModel(config.embedder);
      } else {
...
https://mastra.ai/en/docs/memory/overview`
  ...
  setEmbedder(embedder, embedderOptions) {
    if (typeof embedder === "string") {
      this.embedder = new chunkFXH6E6IX_cjs.ModelRouterEmbeddingModel(embedder);
    } else {
  ...
  getMergedThreadConfig(config) {
    ...
    const mergedConfig = chunkPPEP5ZHX_cjs.deepMerge(this.threadConfig, config || {});
...
var MockMemory = class extends MastraMemory {
  constructor({
    ...
    super({
      name: "mock",
      storage: storage || new chunkZEWJUWNE_cjs.InMemoryStore(),
      options: {
  ...
  listTools(_config) {
    ...
    return {
      updateWorkingMemory: chunkOZ75PBBK_cjs.createTool({
...
//# sourceMappingURL=chunk-PS5SHNDR.cjs.map
//# sourceMappingURL=chunk-PS5SHNDR.cjs.map