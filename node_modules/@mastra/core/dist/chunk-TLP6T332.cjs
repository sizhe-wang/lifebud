...
var chunk5KJXHJ4M_cjs = require('./chunk-5KJXHJ4M.cjs');
var chunk4U7ZLI36_cjs = require('./chunk-4U7ZLI36.cjs');
var chunkUIGRFDO6_cjs = require('./chunk-UIGRFDO6.cjs');

// src/llm/model/gateways/netlify.ts
var NetlifyGateway = class extends chunk5KJXHJ4M_cjs.MastraModelGateway {
  id = "netlify";
  ...
  async resolveLanguageModel({
    ...
    switch (providerId) {
      case "openai":
        return chunk5KJXHJ4M_cjs.createOpenAI({ apiKey, baseURL, headers }).responses(modelId);
      case "gemini":
        return chunk5KJXHJ4M_cjs.createGoogleGenerativeAI({
      ...
      case "anthropic":
        return chunk5KJXHJ4M_cjs.createAnthropic({
          apiKey,
          baseURL: `${baseURL}/v1/`,
          headers: {
      ...
      default:
        return chunk5KJXHJ4M_cjs.createOpenAICompatible({ name: providerId, apiKey, baseURL, supportsStructuredOutputs: true }).chatModel(
          modelId
        );
    }
  }
...
//# sourceMappingURL=chunk-TLP6T332.cjs.map
//# sourceMappingURL=chunk-TLP6T332.cjs.map