...
var provider_registry_default = {
  providers: {
    ...
    cerebras: {
      ...
      apiKeyHeader: "Authorization",
      name: "Cerebras",
      models: ["gpt-oss-120b", "qwen-3-235b-a22b-instruct-2507", "zai-glm-4.6", "zai-glm-4.7"],
  ...
  models: {
    ...
    "zai-coding-plan": ["glm-4.5", "glm-4.5-air", "glm-4.5-flash", "glm-4.5v", "glm-4.6", "glm-4.6v", "glm-4.7"],
    "ollama-cloud": [
      "cogito-2.1:671b-cloud",
      "deepseek-v3.1:671b-cloud",
      "gemini-3-pro-preview:latest",
    ...
    "minimax-cn": ["MiniMax-M2", "MiniMax-M2.1"],
    ...
    zai: ["glm-4.5", "glm-4.5-air", "glm-4.5-flash", "glm-4.5v", "glm-4.6", "glm-4.6v", "glm-4.7"],
    inference: [
      "google/gemma-3",
      "meta/llama-3.1-8b-instruct",
      "meta/llama-3.2-11b-vision-instruct",
    ...
    cerebras: ["gpt-oss-120b", "qwen-3-235b-a22b-instruct-2507", "zai-glm-4.6", "zai-glm-4.7"],
    netlify: [
      "anthropic/claude-3-5-haiku-20241022",
      "anthropic/claude-3-7-sonnet-20250219",
      "anthropic/claude-3-haiku-20240307",
...
function getPackageRoot() {
  try {
    const require2 = module$1.createRequire((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('chunk-XSZDTNNS.cjs', document.baseURI).href)) || "file://");
...
var GatewayRegistry = class _GatewayRegistry {
  ...
  async syncGateways(forceRefresh = false, writeToSrc = false) {
    ...
    try {
      const { ModelsDevGateway } = await import('./models-dev-LODB2BT7.cjs');
      const { NetlifyGateway } = await import('./netlify-J34TDGDT.cjs');
...
//# sourceMappingURL=chunk-XSZDTNNS.cjs.map
//# sourceMappingURL=chunk-XSZDTNNS.cjs.map