...
> **Code References:**
- `Agent`: dist/agent/agent.d.ts → dist/chunk-5A5RM7PH.js:16630
...
Mastra supports more than 600 models. Choose from the [full list](https://mastra.ai/models/v1).
...
Visit [Agent reference](https://mastra.ai/reference/v1/agents/agent) for more information.
...
Visit [.generate()](https://mastra.ai/reference/v1/agents/generate) or [.stream()](https://mastra.ai/reference/v1/streaming/agents/stream) for more information.
...
Visit [Structured Output](https://mastra.ai/docs/v1/agents/structured-output) for more information.
...
Visit [Using Tools](https://mastra.ai/docs/v1/agents/using-tools) for more information.
...
See [Request Context](https://mastra.ai/docs/v1/server/request-context) for more information.

## Testing with Studio

Use [Studio](https://mastra.ai/docs/v1/getting-started/studio) to test agents with different messages, inspect tool calls and responses, and debug agent behavior.
