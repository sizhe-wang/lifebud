# Configuration.mdx API Reference

> API reference for configuration.mdx - 1 entries
...
> Reference documentation on Mastra

The following reference covers all supported options in Mastra. You initialize and configure Mastra by instantiating the [`Mastra` class](https://mastra.ai/reference/v1/core/mastra-class).
...
Visit the [Agents documentation](https://mastra.ai/docs/v1/agents/overview) to learn more.
...
Visit the [Deployment documentation](https://mastra.ai/docs/v1/deployment/overview) to learn more.
...
Visit the [Custom Gateways documentation](https://mastra.ai/models/v1/gateways/custom-gateways) to learn more.
...
Visit the [Logging documentation](https://mastra.ai/docs/v1/observability/logging) to learn more.
...
Visit the [MCP Overview](https://mastra.ai/docs/v1/tools-mcp/mcp-overview) to learn more.
...
Visit the [Memory documentation](https://mastra.ai/docs/v1/memory/overview) to learn more.
...
Visit the [Observability documentation](https://mastra.ai/docs/v1/observability/overview) to learn more.
...
Visit the [Processors documentation](https://mastra.ai/docs/v1/agents/processors) to learn more.
...
Visit the [Scorers documentation](https://mastra.ai/docs/v1/evals/overview) to learn more.
...
Visit the [Storage documentation](https://mastra.ai/docs/v1/memory/storage) to learn more.
...
Visit the [Tools documentation](https://mastra.ai/docs/v1/tools-mcp/overview) to learn more.
...
Visit the [Voice documentation](https://mastra.ai/docs/v1/voice/overview) to learn more.
...
Visit the [RAG documentation](https://mastra.ai/docs/v1/rag/overview) to learn more.
...
Visit the [Workflows documentation](https://mastra.ai/docs/v1/workflows/overview) to learn more.
...
By default, `mastra build` sets this option to `true`. If you deploy your project to [Mastra Cloud](https://mastra.ai/docs/v1/mastra-cloud/overview), it also sets this option to `true`.
...
Visit the [Custom API routes](https://mastra.ai/docs/v1/server/custom-api-routes) documentation to learn more.
...
Visit the [Authentication documentation](https://mastra.ai/docs/v1/server/auth) to learn more.
...
Visit the [Middleware documentation](https://mastra.ai/docs/v1/server/middleware) to learn more.
