...
**Prompt Objects:** See the [`createScorer`](https://mastra.ai/reference/v1/evals/create-scorer) API reference for details on using prompt objects with generateScore, including required `calculateScore` function.
...
Visit [createScorer](https://mastra.ai/reference/v1/evals/create-scorer) for the full API and configuration options.
...
- [createScorer API Reference](https://mastra.ai/reference/v1/evals/create-scorer) - Complete technical documentation
