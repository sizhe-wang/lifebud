...
- Learn about [creating custom scorers](https://mastra.ai/docs/v1/evals/custom-scorers)
- Explore [built-in scorers](https://mastra.ai/docs/v1/evals/built-in-scorers)
- Read the [runEvals API reference](https://mastra.ai/reference/v1/evals/run-evals)