...
> **Code References:**
- `Mastra`: dist/mastra/index.d.ts → dist/chunk-52NRCLCF.js:24
- `Workflow`: dist/workflows/workflow.d.ts → dist/chunk-5A5RM7PH.js:8246
- `Run`: dist/workflows/index.d.ts → dist/chunk-5A5RM7PH.js:9076
...
- **[Default](https://mastra.ai/docs/v1/observability/tracing/exporters/default)** - Persists traces to local storage for viewing in Studio
- **[Cloud](https://mastra.ai/docs/v1/observability/tracing/exporters/cloud)** - Sends traces to Mastra Cloud for production monitoring and collaboration
...
- **[PostHog](https://mastra.ai/docs/v1/observability/tracing/exporters/posthog)** - Sends traces to PostHog for AI analytics and product insights
...
- **[OpenTelemetry Bridge](https://mastra.ai/docs/v1/observability/tracing/bridges/otel)** - Integrate with existing OpenTelemetry infrastructure
...
- [Sensitive Data Filter](https://mastra.ai/docs/v1/observability/tracing/processors/sensitive-data-filter) redacts sensitive information. It is enabled in the default observability config.
...
- [Configuration API](https://mastra.ai/reference/v1/observability/tracing/configuration) - ObservabilityConfig details
- [Tracing Classes](https://mastra.ai/reference/v1/observability/tracing/instances) - Core classes and methods
- [Span Interfaces](https://mastra.ai/reference/v1/observability/tracing/spans) - Span types and lifecycle
- [Type Definitions](https://mastra.ai/reference/v1/observability/tracing/interfaces) - Complete interface reference
...
- [OpenTelemetry Bridge](https://mastra.ai/reference/v1/observability/tracing/bridges/otel) - OTEL context integration

### Processors

- [Sensitive Data Filter](https://mastra.ai/docs/v1/observability/tracing/processors/sensitive-data-filter) - Data redaction