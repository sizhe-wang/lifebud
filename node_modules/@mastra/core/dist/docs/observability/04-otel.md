> Integrate Mastra tracing with existing OpenTelemetry infrastructure
...
If you don't have existing OpenTelemetry instrumentation, the [OpenTelemetry Exporter](https://mastra.ai/docs/v1/observability/tracing/exporters/otel) may be simpler — it sends traces directly without requiring an OTEL SDK setup.
...
For details on span naming and attributes, see the [OpenTelemetry Exporter semantic conventions](https://mastra.ai/docs/v1/observability/tracing/exporters/otel#opentelemetry-semantic-conventions).
...
- [OpenTelemetry Exporter](https://mastra.ai/docs/v1/observability/tracing/exporters/otel) - For sending traces to OTEL backends
- [OtelBridge Reference](https://mastra.ai/reference/v1/observability/tracing/bridges/otel) - API documentation