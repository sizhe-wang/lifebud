> Send traces to any OpenTelemetry-compatible observability platform
...
If you have existing OpenTelemetry instrumentation and want Mastra traces to inherit context from active OTEL spans, see the [OpenTelemetry Bridge](https://mastra.ai/docs/v1/observability/tracing/bridges/otel) instead.
...
- [OpenTelemetry Bridge](https://mastra.ai/docs/v1/observability/tracing/bridges/otel)
...
- [OTEL Exporter Reference](https://mastra.ai/reference/v1/observability/tracing/exporters/otel)