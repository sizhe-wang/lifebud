...
Visit [Agent.stream()](https://mastra.ai/reference/v1/streaming/agents/stream) for more information.
...
Visit [Agent.network()](https://mastra.ai/reference/v1/agents/network) for more information.
