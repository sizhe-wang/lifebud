...
> API reference for templates - 1 entries


---

## Reference: LLM provider API keys (choose one or more)

> Complete guide to creating, using, and contributing Mastra templates
...
For information on contributing your own templates to the Mastra ecosystem, see the [Contributing Templates](https://mastra.ai/docs/v1/community/contributing-templates) guide in the community section.
