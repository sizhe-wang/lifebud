...
- [`getStepResult()`](https://mastra.ai/reference/v1/workflows/workflow-methods/map#using-getstepresult): Access a specific step's full output
- [`getInitData()`](https://mastra.ai/reference/v1/workflows/workflow-methods/map#using-getinitdata): Access the workflow's initial input data
- [`mapVariable()`](https://mastra.ai/reference/v1/workflows/workflow-methods/map#using-mapvariable): Use declarative object syntax to extract and rename fields
