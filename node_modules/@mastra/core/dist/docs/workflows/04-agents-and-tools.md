...
Visit [Structured Output](https://mastra.ai/docs/v1/agents/structured-output) for more options like error handling strategies and streaming with structured output.
...
Visit [Calling Tools](https://mastra.ai/docs/v1/workflows/agents-and-tools#calling-tools) for more examples.
...
- [Using Agents](https://mastra.ai/docs/v1/agents/overview)
