...
var chunkS7MI4RFN_cjs = require('../../chunk-S7MI4RFN.cjs');
...
var getTraceStep = chunkS7MI4RFN_cjs.createStep({
...
async function validateAndSaveScore({ storage, scorerResult }) {
  ...
  const payloadToSave = chunkU6CL7U6Y_cjs.saveScorePayloadSchema.parse(scorerResult);
...
var scoreTracesWorkflow = chunkS7MI4RFN_cjs.createWorkflow({
