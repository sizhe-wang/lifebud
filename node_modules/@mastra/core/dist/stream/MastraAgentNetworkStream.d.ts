...
export declare class MastraAgentNetworkStream<OUTPUT = undefined> extends ReadableStream<ChunkType<OUTPUT>> {
    ...
    get result(): Promise<import("../workflows").WorkflowResult<unknown, unknown, unknown, Step<string, unknown, unknown, unknown, unknown, unknown, DefaultEngineType>[]> | undefined>;
    get usage(): Promise<{
        inputTokens: number;
        outputTokens: number;
        totalTokens: number;
