...
export declare class DefaultStepResult<TOOLS extends ToolSet> implements StepResult<TOOLS> {
    ...
    get text(): string;
    get reasoning(): import("@internal/ai-sdk-v5").ReasoningOutput[];
    get reasoningText(): string | undefined;
    get files(): import("@internal/ai-sdk-v5").Experimental_GeneratedImage[];
    ...
    get toolCalls(): (({
        ...
        providerMetadata?: import("@internal/ai-sdk-v5").ProviderMetadata;
    }) | ({
        type: "tool-call";
