...
import type { AnySpan, TracingContext, TracingPolicy, TracingProperties } from '../observability/index.js';
...
export type PathsToStringProps<T> = T extends z.ZodObject<infer V> ? PathsToStringProps<V> : T extends object ? {
    [K in keyof T]: T[K] extends object ? K extends string ? // @ts-ignore
    K | `${K}.${PathsToStringProps<T[K]>}` : never : K extends string ? K : never;
}[keyof T] : never;
 ...
 */
export type StepParams<TStepId extends string, TStateSchema extends z.ZodTypeAny | undefined, TInputSchema extends z.ZodTypeAny, TOutputSchema extends z.ZodTypeAny, TResumeSchema extends z.ZodTypeAny | undefined = undefined, TSuspendSchema extends z.ZodTypeAny | undefined = undefined> = {
    id: TStepId;
    description?: string;
    ...
    execute: ExecuteFunction<TStateSchema extends z.ZodTypeAny ? z.infer<TStateSchema> : unknown, z.infer<TInputSchema>, z.infer<TOutputSchema>, TResumeSchema extends z.ZodTypeAny ? z.infer<TResumeSchema> : unknown, TSuspendSchema extends z.ZodTypeAny ? z.infer<TSuspendSchema> : unknown, DefaultEngineType>;
};
/**
...
export type WorkflowResult<TState, TInput, TOutput, TSteps extends Step<string, any, any, any, any, any>[]> = ({
    ...
    input: TInput;
    steps: {
        [K in keyof StepsRecord<TSteps>]: StepsRecord<TSteps>[K]['outputSchema'] extends undefined ? StepResult<unknown, unknown, unknown, unknown> : StepResult<InferZodLikeSchema<NonNullable<StepsRecord<TSteps>[K]['inputSchema']>>, InferZodLikeSchema<NonNullable<StepsRecord<TSteps>[K]['resumeSchema']>>, InferZodLikeSchema<NonNullable<StepsRecord<TSteps>[K]['suspendSchema']>>, InferZodLikeSchema<NonNullable<StepsRecord<TSteps>[K]['outputSchema']>>>;
    };
} & TracingProperties) | ({
    status: 'failed';
    input: TInput;
