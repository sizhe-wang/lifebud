...
var getToJsonSchemaFn = async (vendor) => {
  ...
  switch (vendor) {
    case "arktype":
      ...
      break;
    case "effect":
      vendorFnPromise = (await import('./effect-QlVUlMFu-HN3LWZSQ.cjs')).default();
      break;
    case "sury":
      vendorFnPromise = (await import('./sury-CWZTCd75-KEHKUXG7.cjs')).default();
      break;
    case "typebox":
      vendorFnPromise = (await import('./typebox-Dei93FPO-RDSW6DFA.cjs')).default();
      break;
    case "valibot":
      vendorFnPromise = (await import('./valibot--1zFm7rT-NVADAEQI.cjs')).default();
      break;
    case "zod":
      vendorFnPromise = (await import('./zod-Bwrt9trS-ZZHFZ7YQ.cjs')).default();
      break;
    default:
...
//# sourceMappingURL=chunk-JRUJ546M.cjs.map
//# sourceMappingURL=chunk-JRUJ546M.cjs.map