...
${Object.entries(config.supportedArchitectures).map(([key, value]) => `  ${key}: ${JSON.stringify(value)}`).join("\n")}`
  ...
  async getPackageVersion() {
    const __filename = url.fileURLToPath((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('chunk-JVBCN3RH.cjs', document.baseURI).href)));
...
//# sourceMappingURL=chunk-JVBCN3RH.cjs.map
//# sourceMappingURL=chunk-JVBCN3RH.cjs.map