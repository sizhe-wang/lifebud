...
var chunkVX3VN7FN_cjs = require('./chunk-VX3VN7FN.cjs');
var zod = require('zod');
            ...
            switch (part.type) {
              ...
              case "image": {
                return {
                  type: "image_url",
                  image_url: {
                    url: part.image instanceof URL ? part.image.toString() : `data:${(_a = part.mimeType) != null ? _a : "image/jpeg"};base64,${chunkVX3VN7FN_cjs.convertUint8ArrayToBase64(part.image)}`,
              ...
              case "file": {
                if (part.data instanceof URL) {
                  throw new chunkVX3VN7FN_cjs.UnsupportedFunctionalityError({
...
var openaiFailedResponseHandler = chunkVX3VN7FN_cjs.createJsonErrorResponseHandler({
...
var OpenAIChatLanguageModel = class {
  ...
  async doGenerate(options) {
    ...
    } = await chunkVX3VN7FN_cjs.postJsonToApi({
      url: this.config.url({
        path: "/chat/completions",
        modelId: this.modelId
      }),
      headers: chunkVX3VN7FN_cjs.combineHeaders(this.config.headers(), options.headers),
      body,
      failedResponseHandler: openaiFailedResponseHandler,
      successfulResponseHandler: chunkVX3VN7FN_cjs.createJsonResponseHandler(
      ...
      toolCalls: this.settings.useLegacyFunctionCalling && choice.message.function_call ? [
        {
          ...
          toolCallId: chunkVX3VN7FN_cjs.generateId(),
        ...
        return {
          toolCallType: "function",
          toolCallId: (_a2 = toolCall.id) != null ? _a2 : chunkVX3VN7FN_cjs.generateId(),
  ...
  async doStream(options) {
    ...
    const { responseHeaders, value: response } = await chunkVX3VN7FN_cjs.postJsonToApi({
      url: this.config.url({
        path: "/chat/completions",
        modelId: this.modelId
      }),
      ...
      body,
      failedResponseHandler: openaiFailedResponseHandler,
      successfulResponseHandler: chunkVX3VN7FN_cjs.createEventSourceResponseHandler(
        ...
        new TransformStream({
          transform(chunk, controller) {
            ...
            const mappedToolCalls = useLegacyFunctionCalling && delta.function_call != null ? [
              {
                type: "function",
                id: chunkVX3VN7FN_cjs.generateId(),
              ...
              for (const toolCallDelta of mappedToolCalls) {
                ...
                if (toolCalls[index] == null) {
                  if (toolCallDelta.type !== "function") {
                    throw new chunkVX3VN7FN_cjs.InvalidResponseDataError({
                      data: toolCallDelta,
                  ...
                  if (((_c = toolCall2.function) == null ? void 0 : _c.name) != null && ((_d = toolCall2.function) == null ? void 0 : _d.arguments) != null) {
                    ...
                    if (chunkVX3VN7FN_cjs.isParsableJson(toolCall2.function.arguments)) {
                      controller.enqueue({
                        type: "tool-call",
                        toolCallType: "function",
                        toolCallId: (_e = toolCall2.id) != null ? _e : chunkVX3VN7FN_cjs.generateId(),
                        toolName: toolCall2.function.name,
                ...
                if (((_j = toolCall.function) == null ? void 0 : _j.name) != null && ((_k = toolCall.function) == null ? void 0 : _k.arguments) != null && chunkVX3VN7FN_cjs.isParsableJson(toolCall.function.arguments)) {
                  controller.enqueue({
                    type: "tool-call",
                    toolCallType: "function",
                    toolCallId: (_l = toolCall.id) != null ? _l : chunkVX3VN7FN_cjs.generateId(),
                    toolName: toolCall.function.name,
                    args: toolCall.function.arguments
                  });
...
`;
  ...
  for (const { role, content } of prompt) {
    switch (role) {
      case "system": {
        throw new chunkVX3VN7FN_cjs.InvalidPromptError({
...
var OpenAIEmbeddingModel = class {
  ...
  async doEmbed({
    ...
    if (values.length > this.maxEmbeddingsPerCall) {
      throw new chunkVX3VN7FN_cjs.TooManyEmbeddingValuesForCallError({
    ...
    const { responseHeaders, value: response } = await chunkVX3VN7FN_cjs.postJsonToApi({
      ...
      headers: chunkVX3VN7FN_cjs.combineHeaders(this.config.headers(), headers),
      body: {
        model: this.modelId,
        input: values,
...
var OpenAIImageModel = class {
  ...
  async doGenerate({
    ...
    const { value: response, responseHeaders } = await chunkVX3VN7FN_cjs.postJsonToApi({
      url: this.config.url({
...
var OpenAITranscriptionModel = class {
  ...
  getArgs({
    ...
    var _a, _b, _c, _d, _e;
    const warnings = [];
    const openAIOptions = chunkVX3VN7FN_cjs.parseProviderOptions({
      provider: "openai",
      providerOptions,
      schema: openAIProviderOptionsSchema
    });
    const formData = new FormData();
    const blob = audio instanceof Uint8Array ? new Blob([audio]) : new Blob([chunkVX3VN7FN_cjs.convertBase64ToUint8Array(audio)]);
  ...
  async doGenerate(options) {
    ...
    const {
      ...
      responseHeaders,
      rawValue: rawResponse
    } = await chunkVX3VN7FN_cjs.postFormDataToApi({
      url: this.config.url({
          ...
          content: content.map((part, index) => {
            ...
            switch (part.type) {
              ...
              case "image": {
                return {
                  type: "input_image",
                  image_url: part.image instanceof URL ? part.image.toString() : `data:${(_a = part.mimeType) != null ? _a : "image/jpeg"};base64,${chunkVX3VN7FN_cjs.convertUint8ArrayToBase64(part.image)}`,
                  // OpenAI specific extension: image detail
                  detail: (_c = (_b = part.providerMetadata) == null ? void 0 : _b.openai) == null ? void 0 : _c.imageDetail
                };
              }
...
var OpenAIResponsesLanguageModel = class {
  ...
  async doGenerate(options) {
    ...
    if (response.error) {
      throw new chunkVX3VN7FN_cjs.APICallError({
    ...
    return {
      ...
      sources: outputTextElements.flatMap(
        (content) => content.annotations.map((annotation) => {
          ...
          return {
            sourceType: "url",
            id: (_c2 = (_b2 = (_a2 = this.config).generateId) == null ? void 0 : _b2.call(_a2)) != null ? _c2 : chunkVX3VN7FN_cjs.generateId(),
            url: annotation.url,
          ...
          transform(chunk, controller) {
            ...
            if (isResponseOutputItemAddedChunk(value)) {
              ...
              controller.enqueue({
                ...
                source: {
                  sourceType: "url",
                  id: (_h = (_g = (_f = self.config).generateId) == null ? void 0 : _g.call(_f)) != null ? _h : chunkVX3VN7FN_cjs.generateId(),
...
var OpenAISpeechModel = class {
  ...
  async doGenerate(options) {
    ...
    const {
      ...
      body: requestBody,
      failedResponseHandler: openaiFailedResponseHandler,
      successfulResponseHandler: chunkVX3VN7FN_cjs.createBinaryResponseHandler(),
      abortSignal: options.abortSignal,
      fetch: this.config.fetch
    });
    return {
...
function createOpenAI(options = {}) {
  var _a, _b, _c;
  const baseURL = (_a = chunkVX3VN7FN_cjs.withoutTrailingSlash(options.baseURL)) != null ? _a : "https://api.openai.com/v1";
  const compatibility = (_b = options.compatibility) != null ? _b : "compatible";
  const providerName = (_c = options.name) != null ? _c : "openai";
  const getHeaders = () => ({
    Authorization: `Bearer ${chunkVX3VN7FN_cjs.loadApiKey({
...
//# sourceMappingURL=chunk-AQI6GLTN.cjs.map
//# sourceMappingURL=chunk-AQI6GLTN.cjs.map