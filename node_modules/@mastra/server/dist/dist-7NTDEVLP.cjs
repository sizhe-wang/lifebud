...
var OpenAICompatibleChatLanguageModel = class {
  ...
  constructor(modelId, settings, config) {
    ...
    this.failedResponseHandler = chunkVX3VN7FN_cjs.createJsonErrorResponseHandler(errorStructure);
...
var OpenAICompatibleImageModel = class {
  ...
  async doGenerate({
    ...
    const { value: response, responseHeaders } = await chunkVX3VN7FN_cjs.postJsonToApi({
      ...
      failedResponseHandler: chunkVX3VN7FN_cjs.createJsonErrorResponseHandler(
...
function createXai(options = {}) {
  var _a;
  const baseURL = chunkVX3VN7FN_cjs.withoutTrailingSlash(
...
exports.xai = xai;
//# sourceMappingURL=dist-7NTDEVLP.cjs.map
//# sourceMappingURL=dist-7NTDEVLP.cjs.map