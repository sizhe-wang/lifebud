...
var groqFailedResponseHandler = chunkVX3VN7FN_cjs.createJsonErrorResponseHandler({
...
var GroqChatLanguageModel = class {
  ...
  getArgs({
    ...
    const groqOptions = chunkVX3VN7FN_cjs.parseProviderOptions({
      provider: "groq",
  ...
  async doStream(options) {
    ...
    const { responseHeaders, value: response } = await chunkVX3VN7FN_cjs.postJsonToApi({
      ...
      failedResponseHandler: groqFailedResponseHandler,
      successfulResponseHandler: chunkVX3VN7FN_cjs.createEventSourceResponseHandler(groqChatChunkSchema),
      abortSignal: options.abortSignal,
      fetch: this.config.fetch
    });
    const { messages: rawPrompt, ...rawSettings } = args;
          ...
          transform(chunk, controller) {
            ...
            if (delta.tool_calls != null) {
              for (const toolCallDelta of delta.tool_calls) {
                  ...
                  if (((_f = toolCall2.function) == null ? void 0 : _f.name) != null && ((_g = toolCall2.function) == null ? void 0 : _g.arguments) != null) {
                    ...
                    if (chunkVX3VN7FN_cjs.isParsableJson(toolCall2.function.arguments)) {
                      controller.enqueue({
                        type: "tool-call",
                        toolCallType: "function",
                        toolCallId: (_h = toolCall2.id) != null ? _h : chunkVX3VN7FN_cjs.generateId(),
                        toolName: toolCall2.function.name,
                ...
                if (((_m = toolCall.function) == null ? void 0 : _m.name) != null && ((_n = toolCall.function) == null ? void 0 : _n.arguments) != null && chunkVX3VN7FN_cjs.isParsableJson(toolCall.function.arguments)) {
                  controller.enqueue({
                    type: "tool-call",
                    toolCallType: "function",
                    toolCallId: (_o = toolCall.id) != null ? _o : chunkVX3VN7FN_cjs.generateId(),
                    toolName: toolCall.function.name,
                    args: toolCall.function.arguments
                  });
...
function createGroq(options = {}) {
  var _a;
  const baseURL = (_a = chunkVX3VN7FN_cjs.withoutTrailingSlash(options.baseURL)) != null ? _a : "https://api.groq.com/openai/v1";
  const getHeaders = () => ({
  ...
  provider.textEmbeddingModel = (modelId) => {
    throw new chunkVX3VN7FN_cjs.NoSuchModelError({ modelId, modelType: "textEmbeddingModel" });
  };
...
exports.groq = groq;
//# sourceMappingURL=dist-OF24ZMHH.cjs.map
//# sourceMappingURL=dist-OF24ZMHH.cjs.map