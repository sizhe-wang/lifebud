...
var anthropicFailedResponseHandler = chunkVX3VN7FN_cjs.createJsonErrorResponseHandler({
...
var AnthropicMessagesLanguageModel = class {
  ...
  async getArgs({
    ...
    const anthropicOptions = chunkVX3VN7FN_cjs.parseProviderOptions({
      provider: "anthropic",
      providerOptions,
  ...
  async getHeaders({
    ...
    return chunkVX3VN7FN_cjs.combineHeaders(
...
function createAnthropic(options = {}) {
  var _a;
  const baseURL = (_a = chunkVX3VN7FN_cjs.withoutTrailingSlash(options.baseURL)) != null ? _a : "https://api.anthropic.com/v1";
  const getHeaders = () => ({
    "anthropic-version": "2023-06-01",
    "x-api-key": chunkVX3VN7FN_cjs.loadApiKey({
...
//# sourceMappingURL=dist-P6YSNLL3.cjs.map
//# sourceMappingURL=dist-P6YSNLL3.cjs.map