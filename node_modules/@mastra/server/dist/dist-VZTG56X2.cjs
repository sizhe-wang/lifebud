              ...
              parts.push(
                part.image instanceof URL ? {
                  ...
                  inlineData: {
                    ...
                    data: chunkVX3VN7FN_cjs.convertUint8ArrayToBase64(part.image)
                  }
                }
              );
              break;
...
var googleFailedResponseHandler = chunkVX3VN7FN_cjs.createJsonErrorResponseHandler({
...
var GoogleGenerativeAILanguageModel = class {
  ...
  async getArgs({
    ...
    const warnings = [];
    const googleOptions = chunkVX3VN7FN_cjs.parseProviderOptions({
      provider: "google",
  ...
  async doGenerate(options) {
    ...
    const mergedHeaders = chunkVX3VN7FN_cjs.combineHeaders(
      await chunkVX3VN7FN_cjs.resolve(this.config.headers),
      options.headers
    );
    const {
      responseHeaders,
      ...
      successfulResponseHandler: chunkVX3VN7FN_cjs.createJsonResponseHandler(responseSchema),
  ...
  async doStream(options) {
    const { args, warnings } = await this.getArgs(options);
    const body = JSON.stringify(args);
    const headers = chunkVX3VN7FN_cjs.combineHeaders(
      await chunkVX3VN7FN_cjs.resolve(this.config.headers),
      options.headers
    );
    const { responseHeaders, value: response } = await chunkVX3VN7FN_cjs.postJsonToApi({
      ...
      body: args,
      failedResponseHandler: googleFailedResponseHandler,
      successfulResponseHandler: chunkVX3VN7FN_cjs.createEventSourceResponseHandler(chunkSchema),
      abortSignal: options.abortSignal,
      fetch: this.config.fetch
    });
    const { contents: rawPrompt, ...rawSettings } = args;
...
function createGoogleGenerativeAI(options = {}) {
  var _a;
  const baseURL = (_a = chunkVX3VN7FN_cjs.withoutTrailingSlash(options.baseURL)) != null ? _a : "https://generativelanguage.googleapis.com/v1beta";
  const getHeaders = () => ({
    "x-goog-api-key": chunkVX3VN7FN_cjs.loadApiKey({
  ...
  const createChatModel = (modelId, settings = {}) => {
    ...
    return new GoogleGenerativeAILanguageModel(modelId, settings, {
      ...
      baseURL,
      headers: getHeaders,
      generateId: (_a2 = options.generateId) != null ? _a2 : chunkVX3VN7FN_cjs.generateId,
...
//# sourceMappingURL=dist-VZTG56X2.cjs.map
//# sourceMappingURL=dist-VZTG56X2.cjs.map